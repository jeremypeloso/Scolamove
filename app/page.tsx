        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-social">
              <a
                href="https://www.facebook.com/profile.php?id=61581834893156"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Scolamove sur Facebook"
              >
              ...
              <a
                href="https://www.linkedin.com/company/scolamove/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Scolamove sur LinkedIn"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
